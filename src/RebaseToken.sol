 ...
 * @title Rebase Token
 * @author Aayush
 * @notice This is going to be a cross-chain rebase token that incentivises users to deposit into a vault and gain interest in reward
...
contract RebaseToken is ERC20, Ownable, AccessControl {
    ...
    /**
     * @notice Calculate the balance for the user including the interest rate that has accumlated since the last update (principal balance + some interest that has accured)
     * @param _user The user to calculate balance for
     * @return The balance of the user including the interest that accumulated since the last update
     * 
     */
     ...
     * @param _amount The aount of tokens to transfer
     ...
     * @param _to The user to transfer the tokens to
     * @param _amount The amount of tokens to tranfer
     * @return True if the transfer was successful
     * 
     */
    ...
    function _calculateUserAccumulatedInterestSinceLastUpdate(address _user) internal view returns (uint256 linearInterest) {
        ...
        // (principal amount) + (principal amount * interest * time passed since last update)
        // (principal amount) * (1 + interest * time passed since last update)
