...
contract Vault{
    // we need to pass the token address to the construtor
    ...
    // create a way to add reward(staking / lending / borrowing) to the vault 
    ...
    /**
     * @notice Allows user to deposit ETH into the vault and mint rebase tokens in returns
     * 
     */
